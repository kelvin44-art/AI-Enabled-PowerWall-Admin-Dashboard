        ...
        {data.length === 0 ? (
          ...
          <ResponsiveContainer width="100%" height={400}>
            <LineChart data={data}>
              ...
              <Tooltip />
              <Legend />
              <Line type="monotone" dataKey="wind" stroke="#67fe47" strokeWidth={2} name="Wind Power" />
              <Line type="monotone" dataKey="solar" stroke="#9ca3af" strokeWidth={2} name="Solar Power" />
